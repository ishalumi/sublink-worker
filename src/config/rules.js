...
export const DIRECT_DEFAULT_RULES = new Set(['Private', 'Location:CN', 'Microsoft']);
export const REJECT_ACTION_RULES = new Set(['Ad Block']);

export const PREDEFINED_RULE_SETS = {
	minimal: ['Location:CN', 'Private', 'Non-China'],
	balanced: ['Ad Block', 'Location:CN', 'Private', 'Microsoft', 'Non-China', 'Github', 'Google', 'Youtube', 'AI Services', 'Telegram'],
